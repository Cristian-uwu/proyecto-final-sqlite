package mx.edu.tesoem.cristian.itics.sqlite7t11;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btneliminar(View v){
        ...
        intent. putExtra("dni",et1.getText().toString());
        intent. putExtra("nombre",et2.getText().toString());
        intent. putExtra("ciudad",et3.getText().toString());
        intent. putExtra("numero",et4.getText().toString());
